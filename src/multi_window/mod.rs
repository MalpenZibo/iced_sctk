...
pub trait Application: Sized {
    ...
    fn view(
        &self,
        window: window::Id,
    ) -> Element<'_, Self::Message, Self::Theme, iced_renderer::Renderer>;
    ...
    ///
    /// [`Error`]: crate::Error
    fn run(settings: Settings<Self::Flags>) -> std::result::Result<(), Error>
    where
        Self: 'static,
    {
